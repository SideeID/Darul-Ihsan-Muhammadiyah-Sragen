<x-landing-page-layout>
        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2">
                ...
                <div class="col col-md-8 tanglet-diskusi-container pe-md-5">
                    <a href="{{ url('/berita') }}" class="btn py-2 px-4 rounded-pill border border-secondary btn-kembali">
                        <img src="{{ asset('landingpage/assets/images/arrow-left.svg') }}" alt="" class="">
                    </a>

                    <div class="d-flex align-items-center mb-2">
                        <p class="berita-sumber fw-700 mb-0" id="sumber_berita"></p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="4" height="4" viewBox="0 0 4 4" fill="none">
                            <circle cx="2" cy="2" r="2" fill="black" />
                        </svg>
                        <p class="text-secondary mb-0 berita-date" id="tanggal_berita"></p>
                    </div>
                    <h2 class="berita-judul" id="judul_berita"></h2>
                    <img src="" class="w-100 berita-image" id="image_berita" alt="">

                    <div id="isi_berita">

                    </div>
                    <a href="javascript:window.location=waCurrentPage();" class="awa text-decoration-none d-block" style="width:fit-content!important">
                ...
                <div class="col col-md-4">
                    <h4 class="mb-5 side-article-header mt-5 mt-md-0">Berita Lainnya</h4>
    ...
    <script>
        ...
        //get detail berita
        req({
            url: `${path}/landing/berita/${id}`,
            type: "GET",
            success: function(response) {
                var data = response.data

                $("#judul_berita").html(data.judul)
                $("#sumber_berita").html(data.sumber)
                $("#tanggal_berita").html(moment(data.tanggal).format("DD MMMM YYYY"))
                $("#image_berita").attr("src", path + data.image)
                $("#isi_berita").html(data.isi)
        ...
        req({
            ...
            success: function(response) {
                ...
                $("#list_berita").html(data.map((item) => {
                    return `
                        <div class="w-100 side-article-card p-4">
                            <a href="${path}/berita/${item.id}" class="text-decoration-none text-dark">
