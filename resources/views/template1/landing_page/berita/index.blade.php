<x-landing-page-layout>
    ...
    <script>
                ...
                success: function(response) {
                    ...
                    for (let index = 1; index <= links_length; index++) {
                        if (index === data.current_page) {
                            ...
                            $("#links").append(`<button class="" onclick="setBerita('${path}/landing/berita/paginate?page=${index}')">${index}</button>`)
                        }
                    }
                    ...
                    $("#berita_content").html(
                        data.data.map((item) => {
                            return `
                                <a href="${path}/berita/${item.id}" class="text-decoration-none">
        ...
        $(function() {
            setBerita(`${path}/landing/berita/paginate`)
        });
    </script>
</x-landing-page-layout>