    ...
    <div class="container-lg artikel">
        <div class="card card-main mb-4">
            <div class="card-header border-0 bg-white d-flex flex-column pt-4 px-4 pb-0">
                <a href="{{route('artikel.index')}}" class="d-flex align-items-center text-dark text-decoration-none mb-3">
                    <img src="{{ asset('image/icon/kembali.svg') }}" class="me-1" alt="icon kembali">
                    Kembali
                </a>
                <h5 class="fw-700 text-dark mb-3 mb-sm-0">Detail Artikel</h5>
            </div>
            <div class="card-body overflow-auto p-4 pt-0">
                ...
                <form class="form-artikel" id='form_artikel' action="" enctype="multipart/form-data" method="post">
                    ...
                    <p class="text-black fw-700 mb-4">Gambar Artikel</p>
                    ...
                    <p class="text-black fw-700 mb-4">Detail Artikel</p>
