<x-app-layout>
    <div class="container-lg ads">
        ...
        <div class="card card-main mb-4">
            <div class="card-header border-0 bg-white d-flex align-items-start align-items-sm-center justify-content-between flex-column flex-sm-row pt-4 px-4 pb-0">
                <h5 class="fw-700 text-dark mb-3 mb-sm-0">Iklan Slider</h5>
                <div class="d-flex">
                    <a href="{{route('iklan.slider.tambah')}}" class="btn btn-success fw-700 btn-tambah"><img src="{{ asset('image/icon/icon-tambah-circle.svg') }}" class="me-2" alt=""> Tambah Iklan</a>
                </div>
            </div>
                    ...
                    <table class="table table-scrollable mb-0" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle py-3 py-md-4" scope="col">Link</th>
                                <th class="align-middle py-3 py-md-4" scope="col">Tanggal</th>
                                <th class="align-middle py-3 py-md-4" style="width: 15%;" scope="col">Durasi Tayang</th>
    ...
    <script>
        function changeFilter() {
            ...
            if (filter === "Dipublish") {
                setTable(`{{route('ads.all')}}?class=table-data&table=true&lokasi=slider&status=published`)
            } else {
                setTable(`{{route('ads.all')}}?class=table-data&table=true&lokasi=slider`)
            }
        }

        setTableData = {
            'table-data': ['_increment', 'banner', 'sumber', 'tanggal', 'durasi', 'status', 'is_action']
        }
