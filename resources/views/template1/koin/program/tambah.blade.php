<x-app-layout>
            ...
            <div class="card-body overflow-auto p-4">
                <form class="form-haji" id='form_haji' action="" enctype="multipart/form-data" method="post">
                    ...
                    <section id="step_1">
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group position-relative mb-3 mb-md-4">
                                    <div class="bg-transparent text-decoration-none d-flex align-items-center p-0">
                                        ...
                                        <div>
                                            <div class="text-dark admin-title fw-700"><span id="user-nama">{{auth()->user()->name ?? '-' }}</span></div>
                        ...
                        <button class="btn btn-success w-100 fw-500" type="button" onclick="validateForm1()">SELANJUTNYA</button>
                    </section>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        <div class="img-preview mb-3">
                                            ...
                                            <label for="detail_foto_1" class="h-100 w-100 d-flex flex-column align-items-center justify-content-center">
                                                <img src="{{ asset('image/icon/icon-upload-foto.svg') }}" class="mx-auto mb-3" alt="icon upload foto">
                                                <div class="label-content">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="img-preview mb-3">
                                            ...
                                            <label for="detail_foto_2" class="h-100 w-100 d-flex flex-column align-items-center justify-content-center">
                                                <img src="{{ asset('image/icon/icon-upload-foto.svg') }}" class="mx-auto mb-3" alt="icon upload foto">
                                                <div class="label-content">
                                                    <p class="fw-700 text-black text-center mb-2">Drag & drop image to
                                                        upload, or <span class="text-primary">browse</span></p>
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="img-preview mb-3">
                                            ...
                                            <label for="detail_foto_3" class="h-100 w-100 d-flex flex-column align-items-center justify-content-center">
                                                <img src="{{ asset('image/icon/icon-upload-foto.svg') }}" class="mx-auto mb-3" alt="icon upload foto">
                                                <div class="label-content">
                                                    <p class="fw-700 text-black text-center mb-2">Drag & drop image to
                                                        upload, or <span class="text-primary">browse</span></p>
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="img-preview mb-3">
                                            ...
                                            <label for="detail_foto_4" class="h-100 w-100 d-flex flex-column align-items-center justify-content-center">
                                                <img src="{{ asset('image/icon/icon-upload-foto.svg') }}" class="mx-auto mb-3" alt="icon upload foto">
                                                <div class="label-content">
                                                    <p class="fw-700 text-black text-center mb-2">Drag & drop image to
                                                        upload, or <span class="text-primary">browse</span></p>
    ...
    <script>
        ...
        $("#buttonSubmit").click(function(event) {
            ...
            form.append("dana", derupiah($('#dana').val()))
            form.append("image", $('#foto')[0].files[0])
            form.append("penanggung_jawab", "Admin PCNU")
        ...
        function checkFormStep1(field) {
            var allFilled = true;
            $("#step_1 input[type='text'], #step_1 input[type='file'], #step_1 textarea").each(function() {
                if ($(this).val() === '') {
                    allFilled = false;
                } else {
