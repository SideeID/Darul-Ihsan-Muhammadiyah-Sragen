    ...
    <div class="container mt-5">
        ...
        <div class="mb-5 text-center text-md-start d-flex justify-content-between align-items-center" id="header-berita">
            <div class="mb-3 mb-md-0">
                <h1 class="mb-0 fw-bold warta-berita-title">Kabar Sekolah</h1>
            </div>
            <!-- Kategori Filter -->
            <div
                ...
                <div class="nav-scroll-container">
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active fw-700 text-dark" id="pills-kabarsekolah-tab"
                                data-bs-toggle="pill" data-bs-target="#pills-kabarsekolah" type="button" role="tab"
        ...
        <div class="pt-3 row justify-content-between kabar-arsip-container">
            ...
            <div class="col-lg-8 col-md-9 kabar-berita-news-card-container">
                @if (count($berita) > 0)
                    ...
                    @endforeach
                @else
                    <p>Tidak ada berita terkait Kabar Sekolah.</p>
                @endif
            </div>
