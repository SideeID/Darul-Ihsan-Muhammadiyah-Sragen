...
<body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
        ...
        <div class="body flex-grow-1 px-3 position-relative">
            <div class="container-lg">
                <button class="header-toggler p-0 mb-3" type="button" id="btn_sidebar">
                ...
                <section class="d-flex align-items-sm-center justify-content-between body-header">
                    <h4 class="text-greeting text-dark mb-0">Selamat Datang, <span id="sapa-nama" class="text-success fw-700">{{ auth()->user()->name ?? '-' }}</span></h4>
                    <button class="btn border-0 bg-transparent position-relative toggle-notifikasi p-0" id="toggle_notifikasi" type="button" data-bs-toggle="offcanvas" data-bs-target="#notifikasi" aria-controls="notifikasi">
    ...
    <div class="offcanvas offcanvas-end notifikasi" tabindex="-1" id="notifikasi" aria-labelledby="notifikasiLabel">
        <div class="offcanvas-header d-flex align-items-center justify-content-between mb-4 p-0">
            <h4 class="header fw-700 text-dark border-0 mb-0 p-0" id="notifikasiLabel">Notifikasi</h4>
            <button type="button" class="btn-close p-2 m-0" data-bs-dismiss="offcanvas" aria-label="Close">
                <img src="{{ asset('image/icon/close.svg') }}" alt="icon close">
            </button>
        </div>
        <button class="btn btn-outline-success btn-read p-2 w-100 fw-700 mb-4" onclick="readNotif('all')" id="read_all">Tandai semua sudah dilihat</button>
        <div class="offcanvas-body p-0" id="list_notifikasi"></div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <p class="text-black mb-4">Apakah anda yakin untuk logout?</p>
                    <div class="d-flex align-items-center">
                        <input type="hidden" id="d_id">
                        <button type="button" class="btn btn-secondary fw-700 p-2 me-3 w-50" data-bs-dismiss="modal">Batal</button>
                        <form action="{{ route('logout') }}" method="post" id="logout-form" class="mb-0 w-50">
                            @csrf
                            <button type="submit" class="btn btn-outline-danger fw-700 p-2 w-100">Logout</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="modalConfirm" tabindex="-1" aria-labelledby="modalConfirmLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <p class="text-black mb-4" id="modalConfirmBody">-</p>
                    <div class="d-flex align-items-center">
                        <button type="button" class="btn btn-danger fw-700 p-2 me-3 w-100" data-bs-dismiss="modal">Batal</button>
                        <button type="button" class="btn btn-outline-success fw-700 p-2 w-100" id="modalConfirmOk">Ya</button>
                    </div>
                </div>
            </div>
        </div>
