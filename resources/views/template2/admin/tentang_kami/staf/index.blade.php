<x-app-layout>
    <div class="container-lg staf">
        ...
        <div class="mb-4 card card-main">
            <div
                ...
                <h5 class="mb-3 fw-600 text-dark mb-sm-0 h6">Data Guru/Staff</h5>
                <div class="d-flex">
                    <a href="{{ route('tentang_kami.staf.addstaf') }}" class="btn btn-primary fw-600 btn-tambah"><img
    ...
    <script>
        ...
        function resetFilter() {
            ...
            setTable(
                `{{ route('guru-staff.all') }}?class=table-data&table=true`
            )
        }
        ...
        function changeFilter() {
            ...
            setTable(
                `{{ route('guru-staff.all') }}?class=table-data&table=true&status=${filterStatus}&tanggal=${filterTanggal}`
            )
        }

        setTableData = {
            'table-data': ['_increment', 'nama', 'jabatan', 'badge', 'is_action']
        }
        ...
        $(function() {
            setTable(`{{ route('guru-staff.all') }}?class=table-data&table=true&type=gambar`)
        });
