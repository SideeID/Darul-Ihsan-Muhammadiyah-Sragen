<x-app-layout>
    <div class="container-lg berita">
        <header class="header-view d-flex align-items-end justify-content-between">
            ...
            {{-- <div class="mb-3 btn-group">
                <a href="{{route('informasi.berita.index')}}" class="btn fw-600 active" aria-current="page">List Berita</a>
                <a href="{{route('informasi.berita.kategori')}}" class="btn fw-600">Atur Kategori</a>
            </div> --}}
        </header>
        <div class="mb-4 card card-main">
            <div class="px-4 pt-4 pb-0 bg-white border-0 card-header d-flex align-items-start align-items-sm-center justify-content-between flex-column flex-sm-row">
                ...
                <div class="d-flex">
                    <a href="{{route('informasi.berita.tambah')}}" class="btn btn-primary fw-600 btn-tambah"><img src="{{ asset('image/icon/icon-tambah.svg') }}" class="me-2" alt=""> Tambah Berita</a>
                </div>
            </div>
                ...
                <div class="table-footer d-flex align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="flex-row d-flex align-items-center">
                        ...
                        <p class="mb-0 text-black table-info">
                            Menampilkan <span class="table-show">-</span> data dari <span class="table-total">-</span> data
                        </p>
                    </div>
    ...
    <script>
        ...
        function changeFilter() {
            ...
            setTable(`{{route('berita.all')}}?class=table-data&table=true&status=${filterStatus}&tanggal=${filterTanggal}`)
        }
