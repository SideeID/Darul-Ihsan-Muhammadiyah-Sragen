<x-app-layout>
    <div class="container-lg berita">
        <a href="{{route('informasi.berita.index')}}" class="mb-3 d-flex align-items-center text-dark text-decoration-none text-subdued">
            ...
            <div class="p-4 pt-0 overflow-auto card-body">
                <form class="form-berita" id='form_berita' action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button class="mb-2 btn btn-warning w-100 fw-500" type="button" data-bs-toggle="modal" data-bs-target="#modalConfirm">Edit</button>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="pb-0 border-0 modal-header">
                                    <h1 class="text-center modal-title fw-700 text-dark w-100 fs-5" id="modalConfirmLabel">Konfirmasi Ubah Data</h1>
                                </div>
    ...
    <script>
        ...
        $.ajax(settingsGetDetail).done(function(response) {
            ...
            console.log(data_detail.kategori)
