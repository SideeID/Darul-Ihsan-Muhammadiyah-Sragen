<x-app-layout>
    <div class="container-lg gallery">
        <header class="header-view d-flex align-items-end justify-content-between">
            ...
            {{-- <div class="mb-3 btn-group">
                <a href="{{route('galeri.foto.index')}}" class="btn fw-600 active" aria-current="page">List Foto</a>
                <a href="{{route('galeri.video.index')}}" class="btn fw-600">List Video</a>
            </div> --}}
        </header>
        <div class="mb-4 card card-main">
            <div class="px-4 pt-4 pb-0 bg-white border-0 card-header d-flex align-items-start align-items-sm-center justify-content-between flex-column flex-sm-row">
                <h5 class="mb-3 fw-600 text-dark mb-sm-0 h6">List Galeri Foto Anda</h5>
                <div class="d-flex">
                    <a href="{{route('galeri.foto.tambah')}}" class="btn btn-primary fw-600 btn-tambah"><img src="{{ asset('image/icon/icon-tambah.svg') }}" class="me-2" alt=""> Tambah Galeri Foto</a>
                </div>
            </div>
    ...
    <script>
        ...
        function changeFilter() {
            ...
            setTable(`{{route('gallery.all')}}?class=table-data&table=true&type=gambar&status=${filterStatus}&tanggal=${filterTanggal}`)
        }
