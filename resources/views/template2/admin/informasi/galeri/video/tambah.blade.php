<x-app-layout>
                ...
                <form class="form-galeri" id='form_galeri' action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <label for="file-input" class="btn-file-input d-flex align-items-center justify-content-center w-100">Click to upload file</label>
                        </div>
                        <div class="col-md-6">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-delete-list-item', function() {
                var index = $(this).parent().index();
                uploadedFiles.splice(index, 1); // Remove file from the array
                $(this).parent().remove();
                ...
                reader.onload = function(e) {
                    ...
                    listItem.html(`
                        <div class="card-file-list d-flex align-items-center justify-content-between p-2">
                            ...
                            <button type="button" class="btn-delete-list-item p-0 bg-transparent border-0">
