        ...
        <div class="mb-4 card card-main">
            ...
            <div class="p-4 pt-0 overflow-auto card-body">
                ...
                <form class="form-artikel" id='form_artikel' action="" enctype="multipart/form-data" method="post">
                    ...
                    <button class="mb-2 btn btn-success w-100 fw-500" type="button" data-bs-toggle="modal" data-bs-target="#modalConfirm">SIMPAN DATA ARTIKEL</button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="p-4 modal-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <button type="button" class="p-2 btn btn-outline-success fw-700 w-100" id="submitForm">Simpan Data</button>
                                    </div>
                                </div>
                            </div>
                        </div>
