    ...
    <div class="container-lg artikel">
        <div class="mb-4 card card-main">
            <div class="px-4 pt-4 pb-0 bg-white border-0 card-header d-flex align-items-start align-items-sm-center justify-content-between flex-column flex-sm-row">
                ...
                <div class="d-flex">
                    <a href="{{route('informasi.artikel.tambah')}}" class="btn btn-success fw-700 btn-tambah"><img src="{{ asset('image/icon/icon-tambah-circle.svg') }}" class="me-2" alt=""> Tambah Artikel</a>
                </div>
            </div>
            <div class="p-4 overflow-auto table-data card-body">
                    ...
                    <table class="table mb-0 table-scrollable" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="py-3 text-center align-middle py-md-4" style="width: 15%;" scope="col">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="table-footer d-flex align-items-center justify-content-between flex-column flex-sm-row">
                    <p class="mb-0 text-black table-info">Menampilkan <span class="table-show">-</span> data dari <span class="table-total">-</span> data</p>
