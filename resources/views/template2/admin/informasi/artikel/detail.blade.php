    ...
    <div class="container-lg artikel">
        <div class="mb-4 card card-main">
            <div class="px-4 pt-4 pb-0 bg-white border-0 card-header d-flex flex-column">
                <a href="{{route('informasi.artikel.index')}}" class="mb-3 d-flex align-items-center text-dark text-decoration-none">
            ...
            <div class="p-4 pt-0 overflow-auto card-body">
                <hr class="my-4">
                <form class="form-artikel" id='form_artikel' action="" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    <div class="mb-3 form-group position-relative mb-md-3">
                        ...
                        <input type="text" id="judul" name="judul" class="form-control" placeholder="Judul Artikel" aria-label="Judul Artikel">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="mb-3 form-group position-relative mb-md-3">
                        <textarea name="isi" id="isi" class="form-control" placeholder="Isi Artikel" aria-label="Isi Artikel" style="min-height: 235.336px"></textarea>
                    </div>
                    ...
                    <button class="btn btn-success w-100 fw-500" type="button" data-bs-toggle="modal" data-bs-target="#modalConfirm" id="modalConfirmTrigger">SIMPAN DATA ARTIKEL</button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="p-4 modal-body">
                                    <p class="mb-4 text-black">Apakah data yang anda masukkan sudah benar?, Anda bisa cek kembali jika belum yakin</p>
                                    <div class="d-flex align-items-center">
                                        <input type="hidden" id="d_id">
                                        <button type="button" class="p-2 btn btn-danger fw-700 me-3 w-100" data-bs-dismiss="modal">Batal</button>
                                        <button type="button" class="p-2 btn btn-outline-success fw-700 w-100" id="submitPublish">Simpan Data</button>
                                    </div>
                                </div>
                            </div>
                        </div>
