...
<div class="container">
  ...
  {{-- KONFIRM HAPUS --}}
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-container mb-4">
        <ol class="breadcrumb" style="background-color: #F5F6FA;">
            ...
            <li class="breadcrumb-item"><a href="#" style="text-decoration: none; color:#898FA0;">Berita</a></li>
            <li class="breadcrumb-item active" aria-current="page" style="color:#254B2B; font-weight:500">Data Berita</li>
        </ol>
    </nav>

    <div class="p-5 mb-5" style="background-color:white; border-radius:5px;">
        <div class="data d-flex align-items-center">
            <p class="p-2" style="font-size: 20px; font-weight:500;">Data Berita</p>
            <button class="ms-auto" style="color: white; background-color:#1763D3; border-radius:5px; border:none; padding:0px 15px; height:40px;">
                ...
                <a href="{{ route('admin.konten.berita.tambah') }}" style="text-decoration:none; color:white;">Tambah Berita</a>
            </button>
        </div>
 ...
 <div class="d-flex align-items-center">
        ...
        <div class="table-responsive">
            <table id="table" class="table table-hover table-scrollable">
                <thead>
                    <tr>
                        ...
                        <th style="color: black;">Penulis</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Kegiatan Penutupan Masa Pengenalan Lingkungan Sekolah</td>
                        ...
                        <td class="d-flex justify-content-center align-items-center" style="height: 100px;">
                            <button class="btn btn-outline-secondary btn-sm me-2 d-flex align-items-center justify-content-center" style="height: 40px; width: 40px;">
                                <a href="{{ route('admin.konten.berita.detail') }}" style="text-decoration: none; color:black;"><i class="bi bi-eye"> </i></a>
                            </button>
                    ...
                    <tr>
                        ...
                        <td>Pembelajaran wudhu bagi santri PPAI Darun Najah 2 Karangploso</td>
                        <td>18 Jul 2024 09:35:56</td>
                        <td>Admin</td>
