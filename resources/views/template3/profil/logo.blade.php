        ...
        <div class="content-profil">
            ...
            <div class="row row-logo">
                <div class="col-md-4 col-12">
                    <h5>Logo Yayasan</h5>
                    <img src="{{ asset('template3/image/icon/dimsa-logo.svg') }}" alt="Logo" class="my-3">
                    <div class="col">
                ...
                <div class="col-md-4 col-12 mt-md-0 mt-5">
                    <h5>Logo SMP</h5>
                    <img src="{{ asset('template3/image/icon/dimsa-logo.svg') }}" alt="Logogram" class="my-3">
                    <div class="col">
                        <button class="logo-unduh-btn"><img src="{{ asset('template2/img/document-download.png') }}"
            ...
            <div class="nextpage2">
                ...
                <div class="row-next row">
                    <div class="col-md-6 col-12">
                        <a href="{{ route('akreditasi') }}" class="next-a"><img
                                src="{{ asset('template2/img/arrow-left.png') }}" alt=""> Sebelumnya</a>
                    </div>
                    <div class="col-md-6 col-12 mt-md-0 mt-3">
                        <h3 class="fw-bold">Akreditas</h3>
                    </div>
                </div>
            </div>
        </div>
