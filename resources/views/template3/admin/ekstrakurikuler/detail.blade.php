<x-app-layout>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 d-flex justify-content-end align-items-end">
                            <button class="btn btn-warning mt-auto fw-500 mb-2 w-100" type="button"
                                data-bs-toggle="modal" data-bs-target="#modalConfirm">Simpan Perubahan</button>
                        </div>
                    </div>
    ...
    <script>
        var id_ekskul = {!! json_encode($data) !!};
        let foto_value
        ...
        var settingsGetDetail = {
            "url": `${path}/api/ekskul/detail/${id_ekskul}`,
            "method": "GET",
            "timeout": 0,
        };
        ...
        $.ajax(settingsGetDetail).done(function(response) {
            ...
            if (data_detail.thumbnail === "" || data_detail.thumbnail === null) {
                ...
                $("#img_preview").attr("src", path + data_detail.thumbnail)
        ...
        $('#buttonDelete').click(function(e) {
            ...
            req({
                ...
                success: function(data) {
                    ...
                    window.location.href = `${path}/admin/ekskul/`; // Redirect
                }
            });
        });
        ...
        $("#submitForm").on("click", function(event) {
            ...
            var settings = {
                ...
                "url": `${path}/api/ekskul/update/${id_ekskul}`,
                "method": "POST",
                "timeout": 0,
                "timeout": 0,
