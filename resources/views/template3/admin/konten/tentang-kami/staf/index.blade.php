<x-app-layout>
    ...
    <div class="container-fluid p-3">
        ...
        <div class="row">
            <div class="col-12">
                <h4 class="tentangkami-judul">Guru/Staff</h4>
            </div>
            <div class="col-auto">
                <span class="text-breadcumbs mr-2" style="font-size:14px;">Tentang Kami</span>
                <span class="text-breadcumbs-active">/</span>
                <span class="text-breadcumbs-ml-2" style="font-size:14px;">Guru/Staff</span>
                <span class="text-breadcumbs-active">/</span>
                <span class="text-breadcumbs-active ml-2" style="font-size:14px;">Data Guru/Staff</span>
            </div>
        </div>
        <br>
        ...
        <div class="col-12">
            <div class="card tentangkami-card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="tentangkami-subjudul">Data Guru/Staff</h5>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end mb-4">
                            <a href="{{ route('tentangkami.stafGuru.new') }}" class="btn btn-primary" role="button">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" style="gap: 8px;">
                                            <a href="{{ route('tentangkami.stafGuru.detail') }}"
                                                class="btn btn-outline-secondary aksi-button" role="button">
    ...
    <script>
        ...
        document.getElementById('search').addEventListener('input', function() {
            ...
            rows.forEach(function(row) {
                // Ambil nilai dari kolom Nama dan Jabatan (kolom ke-2 dan ke-3)
