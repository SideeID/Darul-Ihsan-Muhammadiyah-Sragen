    ...
    <div class="container Profil">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb fw-semibold">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="color: #091E6F;">Atur Profill</li>
            </ol>
        </nav>
                        ...
                        <div class="pt-3 detail-akun">
                            <form id="form-detail" class="form-setting" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                                ...
                                <div class="flex items-center gap-4">
                                    <button type="submit" class="btn btn-primary fw-600" data-bs-toggle="modal" data-bs-target="#modalEdit">Simpan Perubahan</button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-black text-center mb-4">Apakah anda yakin ingin mengubah data
                    ini?</p>
