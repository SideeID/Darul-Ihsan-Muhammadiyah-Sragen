<x-app-layout>
    <div class="container-lg testimoni">
        ...
        <div class="mb-4 card card-main">
            <div
                ...
                <h5 class="mb-3 fw-600 text-dark mb-sm-0 h6">Data Testimoni</h5>
                <div class="d-flex">
                    <a href="{{ route('informasi.testimoni.tambah') }}" class="btn btn-primary fw-600 btn-tambah"><img
                    ...
                    <table class="table mb-0 table-scrollable" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle fw-bold" scope="col">Nama</th>
                                <th class="align-middle fw-bold" scope="col">Tahun Lulus</th>
    ...
    <script>
        ...
        function resetFilter() {
            ...
            setTable(
                `{{ route('testimoni.all') }}?class=table-data&table=true`
            )
        }
        ...
        function changeFilter() {
            ...
            setTable(
                `{{ route('testimoni.all') }}?class=table-data&table=true&status=${filterStatus}&tanggal=${filterTanggal}`
                )
        }

        setTableData = {
            'table-data': ['_increment', 'nama', 'wali', 'badge', 'is_action']
        }
        ...
        $(function() {
            ...
            req({
                url: `${path}/api/testimoni/list-all`,
                type: "GET",
        ...
        $("#submitForm").click(function(e) {
            ...
            if (sorotanCount === 3 && status === "true") {
                ...
                req({
                    url: `${path}/api/testimoni/sorotan/${id}?sorotan=${status === "true" ? "true" : "false"}`,
                    type: "GET",
                    success: function(data) {
                        $('#modalConfirm').modal('hide');
                        setTable(`{{ route('testimoni.all') }}?class=table-data&table=true`)
