<x-app-layout>
                ...
                <form class="form-testimoni" id='form_testimoni' action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="gap-5 row">
                        <div class="col-md-8">
                            <div class="mb-3 form-group position-relative">
                                ...
                                <input id="nama" name="nama" class="form-control" placeholder="Tulis nama" aria-label="nama"></input>
                            ...
                            <div class="mb-3 form-group position-relative">
                                ...
                                <input id="wali" name="wali" class="form-control" placeholder="Tulis tahun lulus" aria-label="tahun lulus"></input>
                                <div class="invalid-feedback">Oops, kolom ini tidak boleh kosong. Mohon disi yah.</div>
                            </div>
                        ...
                        <div class="col-md-3 d-flex flex-column align-items-end ms-5">
                            <div class="mb-4 img-preview" style="width: 240px; overflow:hidden;">
                                ...
                                <label for="foto" id="input_foto" class="h-100 w-100 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 d-flex justify-content-end align-items-end">
                            <button class="mt-auto mb-2 btn btn-warning fw-500 w-100" type="button" data-bs-toggle="modal" data-bs-target="#modalConfirm">Edit Data</button>
                        </div>
                    </div>
    ...
    <script>
        ...
        $.ajax(settingsGetDetail).done(function(response) {
            ...
            $('#wali').val(data_detail.wali);
            $('#keterangan').val(data_detail.keterangan);
            $('#publishSekarang').prop('checked', data_detail.status === "published" ? true : false);

            if (!data_detail.file_url) {
                $(".img-preview label").html(`
                    <img src="{{ asset('image/icon/icon-upload-foto.svg') }}" class="mx-auto mb-3" alt="icon upload foto">
                    <div class="label-content">
                        <p class="mb-2 text-center text-black fw-700">Upload image, or <span class="text-primary">browse</span></p>
                ...
                $("#img_preview")
                    .attr("src", data_detail.file_url)
                    .on('error', function() {
                        // console.error("Error loading image from:", data_detail.file_url);
                        $(this).attr("src", "{{ asset('image/icon/icon-upload-foto.svg') }}");
                    });
                ...
                $(".img-preview").append(`
                    <div class="mt-3 d-flex align-items-center justify-content-end"
                        style="position: absolute; top: 0px; right: 15px; display: flex; gap: 10px;">
