                ...
                <form class="form-berita" id='form_majalah' action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 d-flex justify-content-end align-items-end">
                            <button class="btn btn-primary mt-auto fw-500 mb-2 w-100" type="button" data-bs-toggle="modal" data-bs-target="#modalConfirm">Simpan Data</button>
                        </div>
                    </div>
                ...
                if (res.status === "success") {
                    ...
                    if (publish_sekarang === true) {
                        ...
                        var settings = {
                            ...
                            "url": `${path}/majalah.publish_one/${id}`,
                            "method": "POST",
                            "timeout": 0,
                            "processData": false,
                            "mimeType": "multipart/form-data",
