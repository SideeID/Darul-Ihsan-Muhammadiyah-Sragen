<x-app-layout>
    <div class="container-lg staf">
        <header class="header-view d-flex align-items-end justify-content-between">
            <div>
                <h3 class="fw-700">QnA</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Tentang Kami</li>
                        <li class="breadcrumb-item">QnA</li>
                        <li class="breadcrumb-item active" aria-current="page">Data QnA</li>
                    </ol>
                </nav>
            </div>
        </header>
        <div class="mb-4 card card-main">
            <div
                ...
                <h5 class="mb-3 fw-bold text-dark mb-sm-0 h6">Data QnA</h5>
                <div class="d-flex">
                    <a href="{{ route('admin.informasi.qna.tambah') }}" class="btn btn-primary fw-600 btn-tambah d-flex align-items-center"><img
            ...
            <div class="p-4 overflow-auto table-data card-body">
                <div class="py-2 mb-4 d-flex justify-content-between align-items-center">
                    <div class="table-filter d-flex align-items-center">
                        ...
                        <select onchange="changeFilter()" class="form-select filter-element table-filter-select"
                            style="padding: 8px; height: 40px; border-radius:0px; width: 100%; font-weight:500;" id="table-filter-status">
                    ...
                    <div class="input-group" style="width: 300px;">
                        <span class="input-group-text" style="background-color: #F9FAFB; border: none;">
                            <i class="bi bi-search"></i>
                        </span>
                        <input type="text" id="search" class="table-pagination-search form-control"
                            placeholder="Cari sesuatu" style="background-color: #F9FAFB; border: none;">
                    </div>
                </div>
                ...
                <div class="row">
                    <table class="table align-middle" id="table">
                        <thead>
                            <tr>
                                <th class="align-middle fw-bold" style="width: 7%;" scope="col">No <img
                                        src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                        class="ms-2"></th>
                                <th class="align-middle fw-bold" style="width: 25%;" scope="col">Question <img
                                        src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                        class="ms-2"></th>
                                <th class="align-middle fw-bold" style="width: 35%;" scope="col">Answer <img
                                        src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                        class="ms-2"></th>
                                <th class="align-middle fw-bold" scope="col">Status <img
                                        src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                        class="ms-2"></th>
                                <th class="text-center align-middle fw-bold" style="width: 15%;" scope="col">Aksi <img
                                        src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                        class="ms-2"></th>
                            </tr>
                        </thead>
    ...
    <script>
        ...
        function resetFilter() {
            ...
            setTable(
                `{{ route('qna.all') }}?class=table-data&table=true`
            )
        }
        ...
        function changeFilter() {
            ...
            setTable(
                `{{ route('qna.all') }}?class=table-data&table=true&status=${filterStatus}&tanggal=${filterTanggal}`
            )
        }

        setTableData = {
            'table-data': ['_increment', 'question', 'answer', 'badge', 'is_action']
        }
        ...
        $(function() {
            setTable(`{{ route('qna.all') }}?class=table-data&table=true`)
        });
        ...
        $('#buttonDelete').click(function(e) {
            ...
            req({
                url: `${path}/api/qna/delete/${id}`,
                type: "DELETE",
                success: function(data) {
                    $('#modalDelete').modal('hide');
                    setTable(`{{ route('qna.all') }}?class=table-data&table=true&type=gambar`)
