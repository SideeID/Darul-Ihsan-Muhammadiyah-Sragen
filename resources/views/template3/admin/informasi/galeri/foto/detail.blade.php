        ...
        <div class="mb-4 card card-main">
            ...
            <div class="p-4 pt-0 overflow-auto card-body">
                <form class="form-gallery" id='form_gallery' action="" enctype="multipart/form-data"
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modalConfirmGaleri" tabindex="-1"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <button type="button" class="px-4 py-2 btn btn-warning fw-700"
                                            id="submitGalleryForm">Ya, Ubah!</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        $('#buttonDelete').click(function(e) {
            ...
            req({
                ...
                success: function(data) {
                    ...
                    window.location.href = `${path}/admin/informasi/galeri/foto/detail/${id_gallery}`;
                }
            })
        })
