<x-app-layout>
    <div class="container-lg gallery">
        <header class="header-view d-flex align-items-end justify-content-between">
            ...
            <div class="mb-3 btn-group">
                <a href="{{ route('admin.informasi.galeri.foto.index') }}" class="btn fw-600" aria-current="page">Foto</a>
                <a href="{{ route('admin.informasi.galeri.video.index') }}" class="btn fw-600 active">Video</a>
            </div>
        </header>
                    ...
                    <table class="table mb-0 table-scrollable" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle  fw-bold" scope="col">File URL
                                    <img src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                        class="ms-2">
                                </th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-4 text-center text-black">Apakah anda yakin ingin memilih data ini ? Data akan menjadi
                        sorotan di beranda website anda! </p>
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <button type="button" class="px-4 py-2 btn btn-primary fw-700" id="submitForm">Ya,
                            Setuju!</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function changeFilter() {
            ...
            setTable(
                `{{ route('gallery.all') }}?class=table-data&table=true&type=video&status=${filterStatus}&tanggal=${filterTanggal}`
                )
        }

        setTableData = {
            'table-data': ['_increment', 'judul', 'video_link', 'badge', 'is_actionVideo']
        }
