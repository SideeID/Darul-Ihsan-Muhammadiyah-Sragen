<x-app-layout>
    <div class="container-lg berita">
        <header class="header-view d-flex align-items-end justify-content-between">
            ...
            <div class="mb-3 btn-group">
                <a href="{{ route('informasi.berita.index') }}" class="btn fw-600 active"
                    style="padding:20px; background-color:#051244;" aria-current="page">Data Berita</a>
                <a href="{{ route('informasi.berita.kategori') }}" class="btn fw-600" style="padding:20px;">Atur
                    Kategori</a>
            </div>
        </header>
        ...
        <div class="mb-4 card card-main">
            <div
                ...
                <div class="d-flex">
                    <a href="{{ route('informasi.berita.tambah') }}" class="btn btn-primary fw-600 btn-tambah"><img
                    ...
                    <div class="table-filter d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center position-relative" style="width:150%;">
                            <input type="date" onchange="changeFilter()"
                                class="text-sm form-control filter-element fw-600" id="table-filter-tanggal"
                        ...
                        <select onchange="changeFilter()"
                            class="text-sm form-select filter-element table-filter-select fs-6"
    ...
    <script>
        ...
        function resetFilter() {
            ...
            setTable(
                `{{ route('berita.all') }}?class=table-data&table=true`
            )
        }
        ...
        function changeFilter() {
            ...
            setTable(
                `{{ route('berita.all') }}?class=table-data&table=true&status=${filterStatus}&tanggal=${filterTanggal}`)
        }

        setTableData = {
            'table-data': ['_increment', 'banner', 'judul', 'tanggal', 'sumber', 'badge', 'is_action']
        }
