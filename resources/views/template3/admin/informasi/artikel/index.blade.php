<x-app-layout>
    <div class="container-lg artikel">
        <div class="mb-4 card card-main">
            <div
                ...
                <h5 class="mb-3 fw-700 text-dark mb-sm-0">Artikel</h5>
                <div class="d-flex">
                    <a href="{{ route('informasi.artikel.tambah') }}" class="btn btn-success fw-700 btn-tambah"><img
                            src="{{ asset('image/icon/icon-tambah-circle.svg') }}" class="me-2" alt=""> Tambah
                        Artikel</a>
                </div>
            </div>
            <div class="p-4 overflow-auto table-data card-body">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="mb-4 text-black table-length d-flex align-items-center">
                        Menampilkan
                    ...
                    <div class="mb-4 text-black table-filter d-flex align-items-center">
                        <div class="me-2">
                            Filter Status
                ...
                <div class="mb-4 table-wrapper">
                    <table class="table mb-0 table-scrollable" id="table">
                        <thead>
                            <tr>
                                <th class="py-3 align-middle py-md-4" style="width: 5%;" scope="col">No</th>
                                <th class="py-3 align-middle py-md-4" scope="col">Thumbnail</th>
                                <th class="py-3 align-middle py-md-4" scope="col">Judul Artikel</th>
                                <th class="py-3 align-middle py-md-4" scope="col">Tanggal</th>
                                <th class="py-3 align-middle py-md-4" style="width: 15%;" scope="col">Penulis</th>
                                <th class="py-3 align-middle py-md-4" scope="col">Status Publish</th>
                                <th class="py-3 text-center align-middle py-md-4" style="width: 15%;" scope="col">
                                    Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="table-footer d-flex align-items-center justify-content-between flex-column flex-sm-row">
                    <p class="mb-0 text-black table-info">Menampilkan <span class="table-show">-</span> data dari <span
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="px-4 pt-4 pb-0 border-0 modal-header">
                                <h1 class="modal-title fw-700 text-dark fs-5" id="modalFilterLabel">Filter Pencarian
                                    Data</h1>
                            ...
                            <div class="p-4 modal-body">
                                <div class="mb-3 form-group position-relative mb-md-4">
                                    ...
                                    <input type="number" id="tahun" name="tahun" class="form-control"
                                        placeholder="Tahun Daftar" aria-label="Tahun Daftar"
                                        onchange="getInputValue('tahun')">
                                </div>
                                <div class="mb-3 form-group position-relative mb-md-4 form-range-text">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <input type="number" id="min_age" name="min_age" class="form-control"
                                            placeholder="Usia Minimal" aria-label="Usia Minimal">
                                        <hr class="mx-2">
                                        <input type="number" id="max_age" name="max_age" class="form-control"
                                            placeholder="Usia Maksimal" aria-label="Usia Maksimal">
                                    </div>
                                </div>
                                <div class="mb-3 form-group position-relative mb-md-4 form-range-text">
                                    <label for="" class="mb-2 fw-500">Lama Mendaftar</label>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <input type="number" id="min_reg" name="min_reg" class="form-control"
                                            placeholder="Tahun Minimal" aria-label="Tahun Minimal">
                                        <hr class="mx-2">
                                        <input type="number" id="max_reg" name="max_reg" class="form-control"
                                            placeholder="Tahun Maksimal" aria-label="Tahun Maksimal">
                                    </div>
                                </div>
                                    ...
                                    <div class="row" id="no_porsi">
                                        <div class="col-6 col-lg-6 form-check-wrapper">
                                            <div class="mb-3 form-check mb-md-4">
                                                <input class="form-check-input" type="radio" name="no_porsi"
                                                    value="false" id="memiliki"
                                                    onchange="showResetInputRadio('no_porsi')">
                                        ...
                                        <div class="col-2" id="reset_no_porsi" style="display: none;">
                                            <button class="btn btn-outline-danger w-100"
                                                onclick="resetInputRadio('no_porsi')">Batal</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group position-relative">
                                    ...
                                    <div class="row" id="data_diri">
                                        <div class="col-6 col-lg-6 form-check-wrapper">
                                            <div class="mb-3 form-check mb-md-4">
                                                <input class="form-check-input" type="radio" name="data_diri"
                                                    value="true" id="data_lengkap"
                                                    onchange="showResetInputRadio('data_diri')">
                                        ...
                                        <div class="col-6 col-lg-6 form-check-wrapper">
                                            <div class="mb-3 form-check mb-md-4">
                                                <input class="form-check-input" type="radio" name="data_diri"
                                                    value="false" id="data_tidak_lengkap"
                                                    onchange="showResetInputRadio('data_diri')">
                                        ...
                                        <div class="col-2" id="reset_data_diri" style="display: none;">
                                            <button class="btn btn-outline-danger w-100"
                                                onclick="resetInputRadio('data_diri')">Batal</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group position-relative">
                                    ...
                                    <div class="row" id="berkas">
                                        <div class="col-6 col-lg-6 form-check-wrapper">
                                            <div class="mb-3 form-check mb-md-4">
                                                <input class="form-check-input" type="radio" name="berkas"
                                                    value="true" id="berkas_lengkap"
                                                    onchange="showResetInputRadio('berkas')">
                                        ...
                                        <div class="col-6 col-lg-6 form-check-wrapper">
                                            <div class="mb-3 form-check mb-md-4">
                                                <input class="form-check-input" type="radio" name="berkas"
                                                    value="false" id="berkas_tidak_lengkap"
                                                    onchange="showResetInputRadio('berkas')">
                                                <label class="form-check-label text-darker"
                                                    for="berkas_tidak_lengkap">
                                        ...
                                        <div class="col-2" id="reset_berkas" style="display: none;">
                                            <button class="btn btn-outline-danger w-100"
                                                onclick="resetInputRadio('berkas')">Batal</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <button type="button" class="p-2 btn btn-outline-danger fw-700 me-3 w-100"
                                        data-bs-dismiss="modal" onclick="resetFilter()">Reset</button>
                                    <button class="p-2 btn btn-success fw-700 w-100" data-bs-dismiss="modal"
                                        onclick="changeFilter()">Filter Data</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $('#buttonDelete').click(function(e) {
            ...
            req({
                url: `${path}/api/artikel/delete/${id}`,
                type: "GET",
