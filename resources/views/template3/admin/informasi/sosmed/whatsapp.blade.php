<x-app-layout>
    <div class="container-lg sosmed">
        <header class="header-view d-flex align-items-end justify-content-between">
            ...
            <div class="mb-3 btn-group">
                <a href="{{route('sosmed.whatsapp')}}" class="btn fw-600 active" aria-current="page">Whatsap Channel</a>
                <a href="{{route('sosmed.instagram')}}" class="btn fw-600">Instagram</a>
    ...
    <script>
        ...
        function resetFilter() {
            ...
            setTable(
                `{{ route('sosmed.all') }}?class=table-data&table=true&type=wa`
            )
        }
        ...
        function changeFilter() {
            ...
            setTable(`{{route('sosmed.all')}}?class=table-data&table=true&type=wa&status=${filterStatus}&tanggal=${filterTanggal}`)
        }
        ...
        $(function() {
            setTable(`{{route('sosmed.all')}}?class=table-data&table=true&type=wa`)
        });
        ...
        function tambahTautan() {
            ...
            $.ajax(settings).done(function(response) {
                ...
                if (res.status === "success") {
                    // closeLoading();
                    // window.location.href = "{{ route('sosmed.whatsapp') }}";
