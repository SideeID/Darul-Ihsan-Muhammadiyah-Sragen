<x-app-layout>
    <div class="container-lg sosmed">
        <header class="header-view d-flex align-items-end justify-content-between">
            ...
            <div class="mb-3 btn-group">
                ...
                <a href="{{route('sosmed.youtube')}}" class="btn fw-600 active">Youtube</a>
            </div>
        </header>
    ...
    <script>
        ...
        function resetFilter() {
            ...
            setTable(
                `{{ route('sosmed.all') }}?class=table-data&table=true&type=youtube`
            )
        }
        ...
        function changeFilter() {
            ...
            setTable(`{{route('sosmed.all')}}?class=table-data&table=true&type=youtube&status=${filterStatus}&tanggal=${filterTanggal}`)
        }
        ...
        $(function() {
            setTable(`{{route('sosmed.all')}}?class=table-data&table=true&type=youtube`)
        });
