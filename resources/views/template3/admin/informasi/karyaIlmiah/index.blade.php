<x-app-layout>
    <div class="container-lg karya-ilmiah">
        <header class="header-view d-flex align-items-end justify-content-between">
            <div>
                <h3 class="fw-700">Karya Ilmiah</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Informasi</li>
                        <li class="breadcrumb-item">Karya Ilmiah</li>
                        <li class="breadcrumb-item active" aria-current="page">Data Karya Ilmiah</li>
                    </ol>
                </nav>
            </div>
        </header>
        ...
        <div class="mb-4 card card-main">
            <div
                ...
                <h5 class="mb-3 fw-600 text-dark mb-sm-0 h6">Data Karya Ilmiah</h5>
                <div class="d-flex">
                    <a href="{{ route('informasi.karyaIlmiah.tambah') }}" class="btn btn-primary fw-600 btn-tambah"><img
                ...
                <div class="p-2 mb-4 d-flex justify-content-between align-items-center">
                    <div class="table-filter d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center position-relative" style="width:150%;">
                            <input type="date" onchange="changeFilter()"
                                class="form-control filter-element fw-600 text-sm" id="table-filter-tanggal"
    ...
    <script>
        ...
        function resetFilter() {
            ...
            setTable(
                `{{ route('karya-ilmiah.all') }}?class=table-data&table=true`
            )
        }
        ...
        function changeFilter() {
            ...
            setTable(
                `{{ route('karya-ilmiah.all') }}?class=table-data&table=true&status=${filterStatus}&tanggal=${filterTanggal}`
            );
        }
        ...
        $(function() {
            setTable(`{{ route('karya-ilmiah.all') }}?class=table-data&table=true`)

            req({
                url: `${path}/api/karya-ilmiah/list-all`,
                type: "GET",
        ...
        $("#submitForm").click(function(e) {
            ...
            if (sorotanCount === 3 && status === "true") {
                ...
                req({
                    url: `${path}/api/karya-ilmiah/sorotan/${id}?sorotan=${status === "true" ? "true" : "false"}`,
                    type: "GET",
                    success: function(data) {
                        $('#modalConfirm').modal('hide');
                        setTable(`{{ route('karya-ilmiah.all') }}?class=table-data&table=true`)
