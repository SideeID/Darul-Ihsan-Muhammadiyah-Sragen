...
<head>
    ...
    <title>Darul Ihsan Muhammadiyah Sragen</title>
    <link rel="shortcut icon" type="image/png" href="{{ asset('template3/image/icon/dimsa-logo.svg') }}" />
    <!-- Fonts -->
    ...
    <script defer src="{{ asset('template3/js/form.js') }}"></script>
    <script defer src="{{ asset('template3/js/alert.js') }}"></script>
    ...
    <style>
        ...
        .wrappers {
            width: 100%;
            margin: 0 auto;
            background-image: url("../../template3/image/bg-login.svg");
...
<body>
    <div class="wrappers min-vh-100">
        ...
        <div class="left d-flex flex-column">
            <div class="logo mb-3">
                <img src="{{ asset('template3/image/logo-dimsa.png') }}" class="login-logo" alt=""
                    style="width: 20rem">
            </div>
                ...
                <div class="card p-2">
                    <div class="card-body">
                        <div class="logo-mobile mb-2">
                            <img src="{{ asset('template3/image/icon/dimsa-logo.svg') }}" class="login-logo"
                                alt="" style="width: 7rem;">
                            {{-- <div class="logo-text text-center mt-3">
                                <h3>Darul Ihsan <br>Muhammadiyah Sragen</h3>
                            </div> --}}
                        </div>
                        <h3 class="card-title fw-bold">Selamat Datang di Darul Ihsan Muhammadiyah Sragen👋</h3>
                        @if ($errors->any())
                            <div>
                                <ul>
                        ...
                        <form id="form" class="form" method="POST" action="{{ route('login.store') }}">
                            ...
                            <div class="input-wrap mb-3">
                                ...
                                <div class="input input-key d-flex flex-column">
                                    <div class="d-flex">
                            ...
                            <div class="col-12">
                                <button id="login-btn" type="submit" class="btn btn-primary mb-1 col-12"
                                    style="font-weight: 500">Login</button>
                                <a href="" class="btn btn-outline-primary border-0 col-12"
                                    style="font-weight: 500">Daftar Akun</a>
                            </div>
                        </form>
                    </div>
                </div>
