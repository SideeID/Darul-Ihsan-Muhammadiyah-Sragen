<x-app-layout>
    <div class="container-lg staf">
        <header class="header-view d-flex align-items-end justify-content-between">
            <div>
                <h3 class="fw-600">Guru & Staff</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Tentang Kami</li>
                        <li class="breadcrumb-item">Guru & Staff</li>
                        <li class="breadcrumb-item active" aria-current="page">Data Guru & Staff</li>
                    </ol>
                </nav>
            </div>
        </header>
        <div class="mb-4 card card-main">
            <div
                ...
                <h5 class="mb-3 fw-bold text-dark mb-sm-0 h6">Data Guru & Staff</h5>
                <div class="d-flex">
                    <a href="{{ route('tentang_kami.staf.addstaf') }}" class="btn btn-primary fw-600 btn-tambah d-flex align-items-center"><img
                ...
                <div class="py-2 mb-4 d-flex justify-content-between align-items-center">
                    ...
                    <div class="input-group" style="width: 300px;">
                        ...
                        <input type="text" id="search" class="table-pagination-search form-control"
                            placeholder="Search" style="background-color: #F9FAFB; border: none;">
                    </div>
                </div>
                        ...
                        <thead>
                            <tr>
                                <th class="align-middle fw-bold" style="width: 7%;" scope="col">No <img
                                        ...
                                        class="ms-2"></th>
                                <th class="align-middle fw-bold" style="width: 25%;" scope="col">Nama <img
                                        src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                        class="ms-2"></th>
                                <th class="align-middle fw-bold" style="width: 35%;" scope="col">Jabatan <img
                                        src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                        class="ms-2"></th>
    ...
    <script>
        ...
        function resetFilter() {
            ...
            setTable(
                `{{ route('guru-staff.all') }}?class=table-data&table=true&type=guru`
            )
        }
        ...
        function changeFilter() {
            ...
            setTable(
                `{{ route('guru-staff.all') }}?class=table-data&table=true&status=${filterStatus}&type=guru`
            )
        }

        setTableData = {
            'table-data': ['_increment', 'nama', 'jabatan', 'badge', 'is_actionStaff']
        }
        ...
        $(function() {
            setTable(`{{ route('guru-staff.all') }}?class=table-data&table=true&type=guru`)
        });
