<x-app-layout>
  <div class="container-lg staf">
      <header class="header-view d-flex align-items-end justify-content-between">
          <div>
              <h3 class="fw-600">Dewan Yayasan</h3>
              <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                      <li class="breadcrumb-item">Sekolah</li>
                      <li class="breadcrumb-item">Dewan Yayasan</li>
                      <li class="breadcrumb-item active" aria-current="page">Pimpinan Pondok</li>
                  </ol>
              </nav>
          </div>
          <div class="mb-3 btn-group">
            <a href="{{route('admin.tentang_kami.dewan.pimpinan.index')}}" class="btn fw-600 active" aria-current="page">Pimpinan</a>
            <a href="{{route('admin.tentang_kami.dewan.pengasuh.index')}}" class="btn fw-600">Pengasuh</a>
        </div>
      </header>
      <div class="mb-4 card card-main">
          <div
              ...
              <h5 class="mb-3 fw-600 text-dark mb-sm-0 h6">Data Pimpinan</h5>
              <div class="d-flex">
                  <a href="{{ route('admin.tentang_kami.dewan.pimpinan.tambah') }}" class="btn btn-primary fw-600 btn-tambah"><img
          ...
          <div class="p-4 overflow-auto table-data card-body">
              ...
              <div class="row">
                  <table class="table align-middle" id="table">
                      <thead>
                          <tr>
                              <th class="align-middle" style="width: 7%;" scope="col">No <img
                                      src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                      class="ms-2"></th>
                              <th class="align-middle" scope="col">Nama <img
                                      src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                      class="ms-2"></th>
                              <th class="align-middle" scope="col">Jabatan <img
                                      src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                      class="ms-2"></th>
                              <th class="align-middle" scope="col">Status <img
                                      src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                      class="ms-2"></th>
                              <th class="text-center align-middle" style="width: 15%;" scope="col">Aksi <img
                                      src="{{ asset('template2/img/icon-arrow-tabel.svg') }}" alt=""
                                      class="ms-2"></th>
                          </tr>
                      </thead>
  ...
  <script>
      ...
      function resetFilter() {
        ...
        //   document.getElementById('table-filter-tanggal').value = ''
          ...
          setTable(
              `{{ route('guru-staff.all') }}?class=table-data&table=true&type=pimpinan`
          )
      }
      ...
      function changeFilter() {
        ...
        //   var filterTanggal = $('#table-filter-tanggal').val();
          ...
          setTable(
              `{{ route('guru-staff.all') }}?class=table-data&table=true&status=${filterStatus}&type=pimpinan`
          )
      }

      setTableData = {
          'table-data': ['_increment', 'nama', 'jabatan', 'badge', 'is_actionPimpinan']
      }
      ...
      $(function() {
          setTable(`{{ route('guru-staff.all') }}?class=table-data&table=true&type=pimpinan`)
      });
