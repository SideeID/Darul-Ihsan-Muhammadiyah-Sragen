                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-5 form-group position-relative">
                                ...
                                <input type="text" id="jabatan" name="jabatan" class="form-control"
                                    placeholder="Jabatan Pimpinan" required>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-4 img-preview mb-md-5">
                                ...
                                <img src="" id="img_preview" class="preview"
                                    onerror="this.style.display='none'" alt="Foto Pimpinan">
                                <label for="foto"
                    ...
                    if (response.status === "success") {
                        ...
                        setTimeout(function() {
                            window.location.href =
                                "{{ route('admin.tentang_kami.dewan.pimpinan.index') }}";
                        }, 1500);
                    } else {
