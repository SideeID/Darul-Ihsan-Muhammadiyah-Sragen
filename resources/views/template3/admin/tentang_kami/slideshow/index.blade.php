            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="p-4 bg-white border-0 card-header d-flex flex-column">
                        <h5 class="mb-3 fw-700 text-dark mb-sm-0 h6">Setting Slideshow</h5>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex justify-content-end">
                        <button class="m-3 btn btn-primary mb-sm-0 w-50 fw-700" type="button" data-bs-toggle="modal"
                ...
                <form class="form-galeri" id='form_galeri' action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="mb-5 col-md-6">
                            ...
                            <label for="headline_1" class="form-label fw-500"
                                style="color:#101828; font-size:14px;">Headline Hero</label>
                            <input type="headline" class="form-control" id="headline_1"
                        ...
                        <div class="col-md-6">
                            ...
                            <label for="headline_2" class="form-label fw-500"
                                style="color:#101828; font-size:14px;">Headline Hero</label>
                            <input type="headline" class="form-control" id="headline_2"
                                placeholder="Tulis Headline">
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3 img-preview">
                            ...
                            <label for="headline_3" class="form-label fw-500"
                                style="color:#101828; font-size:14px;">Headline Hero</label>
                            <input type="headline" class="form-control" id="headline_3"
                                placeholder="Tulis Headline">
                        </div>
                        {{-- <div class="col-md-6">
                            <div class="mb-3 img-preview">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="mb-4 text-center text-black">Apakah anda yakin ingin menyimpan perubahan
                                        data ini? </p>
    ...
    <script>
        ...
        $.ajax(settingsGetDetail).done(function(response) {
            ...
            data_detail.map((item, index) => {
                ...
                $(`#headline_${index + 1}`).val(item.headline)
        ...
        $("#submitForm").on("click", function(event) {
            ...
            if ($('#foto_1').attr('data-id')) {
                ...
                form.append("headline[]", $('#headline_1').val());
            } else if ($('#foto_1').val() !== "") {
            ...
            if ($('#foto_2').attr('data-id')) {
                ...
                form.append("headline[]", $('#headline_2').val());
            } else if ($('#foto_2').val() !== "") {
            ...
            if ($('#foto_3').attr('data-id')) {
                ...
                form.append("headline[]", $('#headline_3').val());
            } else if ($('#foto_3').val() !== "") {
