        ...
        <div class="row d-flex justify-content-between">
            <div class="col-md-10">
                <h1 style="font-weight:600;"><span class="d-none d-md-flex mb-0">Gabung di</span>
                    SMP Darul Ihsan Muhammadiyah Sragen<br>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-5 mb-4 px-0 mx-0">
                <h4>SMP Darul Ihsan<br>Muhammadiyah Sragen</h4>
            </div>
            <div class="col-lg-7 px-0 mx-0">
                <h4 class="title mb-3">Tentang</h4>
                <p class="text mb-2">SMP di Pondok Pesantren Darul Ihsan Muhammadiyah Sragen dirancang untuk memberikan
                    pendidikan komprehensif yang menggabungkan kurikulum nasional dengan pendidikan agama Islam yang
                    mendalam. Program ini bertujuan untuk membentuk siswa dengan fondasi ilmu pengetahuan yang kuat,
                    serta akhlak dan nilai-nilai keislaman yang kokoh. Dengan dukungan tenaga pendidik yang
                    berpengalaman dan fasilitas yang memadai, kami memastikan bahwa para siswa SMP dapat mengembangkan
                    potensi mereka baik secara akademis maupun spiritual, mempersiapkan mereka untuk melanjutkan
                    pendidikan ke jenjang yang lebih tinggi dengan kepercayaan diri dan keterampilan yang relevan.
                </p>
...
<style>
    #hero-smp {
        background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.7)), url("../../template3/image/hero-smp.svg");
