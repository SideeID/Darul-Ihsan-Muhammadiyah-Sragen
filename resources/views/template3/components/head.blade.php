...
<head>
    ...
    <title>DIMSA-DARUL IHSAN MUHAMADIYAH SRAGEN</title>
    <link rel="shortcut icon" type="image/png" href="{{asset('template3/image/logo-dimsa.png')}}" />
    ...
    <link href="{{ asset('template3/css/berita.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('template3/css/home.css') }}" />
